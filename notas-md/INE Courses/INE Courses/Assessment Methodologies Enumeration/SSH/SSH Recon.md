...
```
root@attackdefense:~# nmap -sV 192.166.238.3 --script ssh2-enum-algos -p22
Starting Nmap 7.70 ( https://nmap.org ) at 2023-11-25 16:53 UTC
Nmap scan report for target-1 (192.166.238.3)
...
|       none
|_      zlib@openssh.com
MAC Address: 02:42:C0:A6:EE:03 (Unknown)
Service Info: OS: Linux; CPE: cpe:/o:linux:linux_kernel

Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
Nmap done: 1 IP address (1 host up) scanned in 0.44 seconds

root@attackdefense:~# nmap -sV 192.166.238.3 -p22 --script ssh-hostkey --script-args ssh_hostkey=full
Starting Nmap 7.70 ( https://nmap.org ) at 2023-11-25 16:57 UTC
Nmap scan report for target-1 (192.166.238.3)
Host is up (0.000049s latency).
...
root@attackdefense:~# nmap -sV 192.166.238.3 -p22 --script ssh-auth-methods --script-args="ssh.user=student"
Starting Nmap 7.70 ( https://nmap.org ) at 2023-11-25 16:59 UTC
Nmap scan report for target-1 (192.166.238.3)
...
```
root@attackdefense:~# ssh student@192.166.238.3
