...
learning_refs: [portswigger/file-path-traversal-simple-case, portswigger/file-path-traversal-absolute-path-bypass, portswigger/file-path-traversal-sequences-stripped-non-recursively, portswigger/file-path-traversal-superfluous-url-decode, portswigger/file-path-traversal-validate-start-of-path, portswigger/file-path-traversal-validate-file-extension-null-byte-bypass]
---
