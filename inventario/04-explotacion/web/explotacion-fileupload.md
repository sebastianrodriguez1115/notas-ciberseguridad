...
learning_refs: [portswigger/file-upload-rce-via-web-shell-upload, portswigger/file-upload-content-type-restriction-bypass, portswigger/file-upload-path-traversal, portswigger/file-upload-extension-blacklist-bypass, portswigger/file-upload-obfuscated-file-extension, portswigger/file-upload-polyglot-web-shell, portswigger/file-upload-race-condition]
---
