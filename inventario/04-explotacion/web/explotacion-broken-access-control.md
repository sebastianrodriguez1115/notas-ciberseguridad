...
learning_refs: [portswigger/unprotected-admin-functionality, portswigger/unprotected-admin-functionality-with-unpredictable-url, portswigger/user-role-controlled-by-request-parameter, portswigger/user-role-can-be-modified-in-user-profile, portswigger/url-based-access-control-can-be-circumvented, portswigger/method-based-access-control-can-be-circumvented, portswigger/multi-step-process-with-no-access-control-on-one-step, portswigger/referer-based-access-control]
---
